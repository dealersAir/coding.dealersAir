...
<body>
   ...
   <header class="header">
      <div class="row row_wrp row_col-middle">
         <div class="col col-grow p-y-0">
            <a href="index.html" class="header__logo"><img src="/images/dealersair.svg" alt="dealersAir"></a>
         </div>
         <div class="col-10 sm-col-3 p-y-0">
               ...
               <nav class="header__nav">
                  ...
                  <ul class="menu">
                     <li class="menu__item menu__item_has-children">
                        <span class="menu__a">Кодинг</span>
